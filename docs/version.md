...
| 1.0.3   | 2026-05-26 | Tightened documentation for conciseness: reduced duplication of disclaimers and risk lists between README, Security-Hardening.md, Compliance-Gaps-and-Remediation-Roadmap.md, and Architecture.md. Condensed Paper-Future-Work-and-Gaps-from-Local-PDF.md. Net removal of redundant prose while preserving all technical content and cross-references. | |
