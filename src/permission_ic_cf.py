...
# extract_predictions is now imported from evaluation_utils (robust multi-strategy + Pydantic)
# The local fragile implementation has been removed to address the paper's robustness gap.
